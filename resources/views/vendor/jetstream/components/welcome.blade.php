<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <!-- START STATS BLOCK -->
        <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-6">
            <div id="jh-stats-positive" class="flex flex-col justify-center px-4 py-4 mt-4 rounded bg-gray-200 bg-opacity-25  sm:mt-0">
                <div>
                    <div>
                    ...
                    <p class="text-lg text-center text-gray-500">Virtual machines</p>
                </div>
            </div>
            <div id="jh-stats-positive" class="flex flex-col justify-center px-4 py-4 mt-4 rounded bg-gray-200 bg-opacity-25  sm:mt-0">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-center text-gray-800">43</p>
                    <p class="text-lg text-center text-gray-500">Aantal flags</p>
                </div>
            </div>
